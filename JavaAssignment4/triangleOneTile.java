...
public class triangleOneTile extends Tile {

  public triangleOneTile(int _rIndex, int _cIndex, Color _color, Board _gameBoard){
    super(_rIndex, _cIndex, _color, _gameBoard, 1);
  }
