...
public class rotateHButton extends JButton implements ActionListener, MouseListener {

    private Scene scene;
    private guiControlPanel controls;

    public rotateHButton (Scene _scene, guiControlPanel _controls) {
	scene = _scene;
	controls = _controls;
	setText("Rotate/Stop-Rotate Vertically");
    ...
    public void actionPerformed (ActionEvent e) {
        System.out.println(getText() + " was pressed. Selected shape rotating horizontally.");
	scene.rotateH(controls.getCurrShape());
    }
